...
| [`openmontage/`](openmontage/README.md) | Thin adapter for a local OpenMontage video-production checkout | Product — opt-in |
| [`opencut/`](opencut/README.md) | Thin adapter for a local OpenCut rewrite checkout; OpenMontage handoff | Product — opt-in |
