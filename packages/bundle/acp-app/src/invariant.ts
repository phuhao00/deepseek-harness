 ...
 * command-line provider whose observable contract (help on stdout, ACP
 * pending until a successful parse) is process-level and owned by the
 * launcher e2e; it registers nothing and holds no mutable relation to audit
 * inside the tree.
 */
