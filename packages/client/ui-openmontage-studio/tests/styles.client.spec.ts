/**
 * Studio CSS modules may only name theme tokens the theme sheets declare.
 */
import { readdirSync, readFileSync } from 'node:fs'
import { fileURLToPath } from 'node:url'
import { describe, expect, it } from 'vitest'

const sheets = ['StudioFooterAction.module.css', 'StudioOverlay.module.css'].map(name =>
