...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/acp-app': { kind: 'none', reason: 'The ACP profile bundle is a patch-list carrier; prompts, tools, and session MCP mounts belong to the composed base and ACP rows.' },
